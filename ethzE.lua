...
local function createPetListGUI(category, pets) local gui = Instance.new("ScreenGui", LocalPlayer:WaitForChild("PlayerGui")) gui.Name = "PetList_" .. category gui.IgnoreGuiInset = true gui.ResetOnSpawn = false
...
local function createMainGUI() for category, pets in pairs(petData) do createPetListGUI(category, pets) end end
